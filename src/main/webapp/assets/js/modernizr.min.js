...
!function (e, t, n) {
    ...
    function i(e) {
        ...
        _ ? T.className.baseVal = t : T.className = t)
    }
    function s() {
    ...
    function f(e, n, r, o) {
        var i, a, f, u, d = "modernizr", c = s("div"), p = l();
        if (parseInt(r, 10))
            for (; r--;)
                f = s("div"),
                f.id = o ? o[r] : d + (r + 1),
    ...
    function g(e, t, o, i) {
        ...
        for (var f, c, p, h, g, v = ["modernizr", "tspan", "samp"]; !R.style && v.length;)
            f = !0,
            R.modElem = s(v.shift()),
    ...
    function v(e, t, n, o, i) {
        ...
        return r(t, "string") || r(t, "undefined") ? g(a, t, o, i) : (a = (e + " " + A.join(s + " ") + s).split(" "),
        p(a, t, n))
    }
    function y(e, t, r) {
        return v(e, n, n, t, r)
    ...
    Modernizr.addTest("csscalc", function () {
        var e = "width:"
          , t = "calc(10px);"
          , n = s("a");
        return n.style.cssText = e + C.join(t + e),
        !!n.style.length
    }),
    Modernizr.addTest("cssgradients", function () {
        for (var e, t = "background-image:", n = "gradient(linear,left top,right bottom,from(#9f9),to(white));", r = "", o = 0, i = C.length - 1; i > o; o++)
            e = 0 === o ? "to " : "",
            r += t + C[o] + "linear-gradient(" + e + "left top, #9f9, white);";
    ...
    Modernizr.addTest("boxsizing", y("boxSizing", "border-box", !0) && (t.documentMode === n || t.documentMode > 7)),
